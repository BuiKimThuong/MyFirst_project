		...
		<div class="container">
			<div id="responsive-nav">
				...
				<div class="category-nav">
					...
					<ul class="category-list">
						<li class="dropdown side-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Áo Ngoại Hạng Anh (Pr.League) <i class="fa fa-angle-right"></i></a>
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
						<li class="col-lg-2 col-md-2 hotline"><a href="tel:0978008392"><i class="fa fa-mobile" aria-hidden="true"></i>ĐIỆN THOẠI<br><span class="hl">0123.456.789</span></a></li>
						
						<li class="col-lg-2 col-md-2 "><a rel="nofollow"><i class="fa fa-truck" aria-hidden="true"></i>GIAO HÀNG<br>TOÀN QUỐC</a></li>
						
						<li class="col-lg-2 col-md-2 "><a rel="nofollow"><i class="fa fa-home" aria-hidden="true"></i>THANH TOÁN<br>TẠI NHÀ</a></li>
						
						<li class="col-lg-2 col-md-2 "><a rel="nofollow"><i class="fa fa-undo" aria-hidden="true"></i>ĐỔI TRẢ<br>
						TRONG 7 NGÀY</a></li>
